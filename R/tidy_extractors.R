# =====================================================================
# PROPOSED ADDITIONS TO curveRcore  (Issue 1, Phase-0 items 1-3)
# Drop these into curveRcore/R/, run devtools::document(), export, and
# ship as an ADDITIVE MINOR release (e.g. 0.x.(y+1) -> see 00 §5).
# They add no new dependency and do not change existing behaviour.
# =====================================================================
