# =============================================================================
# data_core.R — Dataset documentation (curveRcore)
#
# Renamed from data.R to disambiguate from the like-named files in curveRbayes
# / other packages. Content unchanged; this file only documents the two
# example datasets shipped with curveRcore. R sources every R/*.R file
# regardless of name, so the rename is functionally inert (see note below on
# the DESCRIPTION Collate field).
# =============================================================================
